                ...
                <div style={{ display: "flex", width: "100%", justifyContent: "center", alignItems: "center", marginTop: "30px" }}>
                    <div>
                        ...
                        <div style={{ display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
                            ...
                            <a href="https://www.Linkedin.com/in/miko%C5%82aj-mr%C3%B3zek-77b949214/" target="_blank"><Linkedin size={28} className="social-icon" /></a>
                            <a href="https://www.instagram.com/mmrozek.design/" target="_blank"><Instagram size={28} className="social-icon" /></a>
